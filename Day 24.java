// Day 24 of 30 Days Leetcode.

// Problem Number 2096: Step by Step Directions Froma binary tree node to another.
...
class Solution {
  ...
  // Creating string in reverse order to avoid creating a new copy.
